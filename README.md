...
1. As a food seeker, I want to look for a specific food item that is located within a certain # of km from me. (in a nearby locale - within certain # km -> maybe this becomes more flexible to use other units later. This means we need to get the user's location first or ask them to provide the search area/city. ** MVP would be for the user to give us the city and we search that way, thus avoiding a google map api call.)
...
Use Cases (for a a food bank/pantry admin/staff)
...
4. As a food bank admin, I want to delete one of the 2 admins. (needs to be confirmed before being done)
...
13. As a food bank member of staff, I need to create food categories (delete/update them)
